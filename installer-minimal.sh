...
if [ -f /proc/user_beancounters ]; then
  ...
  if [ ! -f /usr/sbin/ntpd ]; then
    ...
    date
    echo
    $YUMDNFBIN -y install ntp${DISABLEREPO_DNF}
    chkconfig ntpd on
