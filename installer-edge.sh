...
if [[ "$CENTOS_NINE" -eq '9' ]]; then
  ...
  echo "NGINX_ZSTD='y'" >> /etc/centminmod/custom_config.inc
...
if [[ "$CENTOS_SEVEN" -eq '7' ]]; then
  ...
  echo "NGINX_PCRE_TWO='y'" >> /etc/centminmod/custom_config.inc
  echo "OPENSSL_VERSION='3.2.2'" >> /etc/centminmod/custom_config.inc
  echo "OPENSSL_VERSIONFALLBACK='3.2.2'" >> /etc/centminmod/custom_config.inc
  echo "OPENSSL_VERSION_OLDOVERRIDE='3.2.2'" >> /etc/centminmod/custom_config.inc
  echo "NGINX_NJS='y'" >> /etc/centminmod/custom_config.inc
  echo "NGXDYNAMIC_NJS='y'" >> /etc/centminmod/custom_config.inc
  echo "NGXDYNAMIC_BROTLI='y'" >> /etc/centminmod/custom_config.inc
  echo "NGINX_LIBBROTLI='y'" >> /etc/centminmod/custom_config.inc
