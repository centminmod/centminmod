...
echo "-w /etc/cron.allow -p wa -k cron" >> "$AUDITRULE_PERMFILE"
echo "-w /etc/cron.deny -p wa -k cron" >> "$AUDITRULE_PERMFILE"
echo "-w /etc/cron.d/ -p wa -k cron" >> "$AUDITRULE_PERMFILE"
echo "-w /etc/cron.daily/ -p wa -k cron" >> "$AUDITRULE_PERMFILE"
echo "-w /etc/cron.hourly/ -p wa -k cron" >> "$AUDITRULE_PERMFILE"
echo "-w /etc/cron.monthly/ -p wa -k cron" >> "$AUDITRULE_PERMFILE"
echo "-w /etc/cron.weekly/ -p wa -k cron" >> "$AUDITRULE_PERMFILE"
echo "-w /etc/crontab -p wa -k cron" >> "$AUDITRULE_PERMFILE"
if [ -f /var/spool/cron/root ]; then
echo "-w /var/spool/cron/root -k cron" >> "$AUDITRULE_PERMFILE"
fi
